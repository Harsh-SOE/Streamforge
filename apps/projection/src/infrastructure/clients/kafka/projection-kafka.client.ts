...
@Injectable()
export class ProjectionKafkaClient implements OnModuleInit, OnModuleDestroy {
  ...
  public constructor(
    ...
    this.kafkaClient = new Kafka({
      ...
      clientId: configService.PROJECTION_CLIENT_ID,
    });

    this.producer = this.kafkaClient.producer({ allowAutoTopicCreation: true });
    this.consumer = this.kafkaClient.consumer({
      groupId: this.configService.PROJECTION_CONSUMER_ID,
