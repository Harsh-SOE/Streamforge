...
import { KafkaMessageBusAdapter } from '@channel/infrastructure/message-bus/adapters';
...
export class ChannelCreatedEventHandler implements IEventHandler<ChannelCreatedEvent> {
  public constructor(@Inject(MESSAGE_BROKER) private readonly messageBus: KafkaMessageBusAdapter) {}
