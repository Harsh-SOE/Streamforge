...
export const KAFKA_EVENT_CONSUMER_CONFIG = Symbol('KAFKA_EVENT_CONSUMER_CONFIG');
...
export class KafkaEventConsumerHandler implements OnModuleInit {
  ...
  public constructor(
    ...
    @Inject(KAFKA_EVENT_CONSUMER_CONFIG) private readonly config: KafkaEventConsumerHandlerConfig,
  ) {
